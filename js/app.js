...
function multiply(a, b) {
  let myMul = a * b;
  let myString = "The product of " + a + " and " + b + " is " + myMul + ".";
  return [myMul, myString];
  //eslint-disable-line
}
...
function sumAndMultiply(a, b, c) {
  let mySumAB = sum(a, b)[0];
  let myTotalSum = sum(mySumAB, c);

  let myMulAB = multiply(a, b)[0];
  let myTotalMul = multiply(myMulAB, c);

  let mySumString =
    a + " and " + b + " and " + c + " sum to " + myTotalSum[0] + ".";
  let myMulString =
    "The product of " +
    a +
    " and " +
  ...
  return [myTotalSum[0], myTotalMul[0], mySumString, myMulString];
